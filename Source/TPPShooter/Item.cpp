...
void AItem::SetItemProperties(EIemState State)
{
	switch (State)
	{
	case EIemState::EIS_Pickup:
	...
	case EIemState::EIS_Equipped:

		// Set PickupWidget properties
		PickupWidget->SetVisibility(false);
...
void AItem::SetItemState(EIemState State)
{
	ItemState = State;
